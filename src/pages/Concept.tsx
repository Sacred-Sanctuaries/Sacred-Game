...
export default function Concept() {
  return (
    <CardPage title="Concept">
      Sacred Sanctuaries is a cooperative Real Life Regeneration Game. While playing, we connect with ourselves, each other and our dreams to manifest them together.<br></br><br></br>
