...
export default function Concept() {
  return (
    <CardPage title="Concept">
      <b>Sacred Game</b> is a cooperative <b>Real Life Manifestation Game</b>. While playing, we connect with ourselves, each other and our dreams to manifest them together.<br></br><br></br>
